...
public class VanillaWeatherModel implements WeatherModel {
    private static final VanillaWeatherModel instance =
            new VanillaWeatherModel();

    @Override
    public void apply(OpenMeteoAPI.WeatherCode weatherCode, ServerWorld serverWorld) {
        ServerWorldProperties worldProperties = (ServerWorldProperties) serverWorld.getLevelProperties();
